...
```bash
git clone https://github.com/dhavalbhalgamiya/Stepper-form.git
...
- **`src/components`**: This folder contains the main components:
  - **StepperComponent **: Handles rendering the individual form inputs

- **`src/templates/HomeStepper.js`**: All the components are imported and rendered inside this template. The dynamic form and its associated data are managed here.

- **`App.js`**: The `HomeStepper` template are imported into `App.js` to initialize the main application structure and logic.
